...
<template>
    <Sheet>
        <SheetContent
            class="flex h-full w-full max-w-md flex-col p-6 sm:h-auto sm:max-w-lg md:max-w-xl lg:max-w-2xl"
        >
            <SheetHeader>
            ...
            <div class="grid flex-1 auto-rows-min gap-4 overflow-y-auto px-2 sm:px-4">
